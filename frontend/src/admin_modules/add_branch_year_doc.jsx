               ...
               <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='text-center mb-8'>
                         <div className='bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-maroon-100 p-6'>
                              <div className='flex items-center justify-center gap-3 mb-4'>
                                   ...
                                   <div>
                                        <h1 className='text-3xl font-bold text-maroon-800'>Create Branch Document</h1>
                                        <p className='text-maroon-600 mt-1'>Setup a new department-year-branch combination</p>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div className='bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-maroon-100 overflow-hidden'>
                         <div className='bg-gradient-to-r from-maroon-600 to-maroon-700 px-6 py-4'>
                              ...
                              <p className='text-maroon-100 text-sm'>Fill in the details for the new academic branch</p>
                         </div>

                         <form onSubmit={handleSubmit} className='p-6 sm:p-8'>
                              {/* Basic Information */}
                              <div className='mb-8'>
                                   <h3 className='text-lg font-semibold text-maroon-800 mb-4 flex items-center gap-2'>
                                        ...
                                        <div className='md:col-span-1'>
                                             ...
                                             <div className='relative'>
                                                  <input
                                                       ...
                                                       min='1'
                                                       max='200'
                                                       className={`w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-maroon-500 transition-all duration-200 ${errors.totalStudents
                                                            ? 'border-red-300 bg-red-50'
                                                            : 'border-maroon-200 focus:border-maroon-500'
                                                            }`}
                              ...
                              {(formData.department || formData.year || formData.branch) && (
                                   <div className='mb-8 p-4 bg-maroon-50 border border-maroon-200 rounded-xl'>
                                        <h3 className='text-lg font-semibold text-maroon-800 mb-3 flex items-center gap-2'>
                                             <div className='w-2 h-2 bg-maroon-600 rounded-full'></div>
                                             Preview
                                        </h3>
                                        <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 text-center'>
                                             <div className='bg-white rounded-lg p-3 border border-maroon-200'>
                                                  <p className='text-xs text-maroon-600 mb-1'>Department</p>
                                                  <p className='font-semibold text-maroon-800'>{formData.department || '---'}</p>
                                             </div>
                                             <div className='bg-white rounded-lg p-3 border border-maroon-200'>
                                                  <p className='text-xs text-maroon-600 mb-1'>Year - Branch</p>
                                                  <p className='font-semibold text-maroon-800'>{formData.year || '---'} {formData.branch ? `- ${formData.branch}` : ''}</p>
                                             </div>
                                             <div className='bg-white rounded-lg p-3 border border-maroon-200'>
                                                  <p className='text-xs text-maroon-600 mb-1'>Total Students</p>
                                                  <p className='font-semibold text-maroon-800'>{formData.totalStudents || '0'}</p>
                                             </div>
                                        </div>
                                   </div>
                              )}
                              ...
                              <div className='flex flex-col sm:flex-row gap-4'>
                                   <button
                                        type='button'
                                        onClick={handleReset}
                                        className='flex-1 sm:flex-none px-6 py-3 border-2 border-maroon-200 text-maroon-700 bg-white hover:bg-maroon-50 rounded-xl font-semibold transition-all duration-200 hover:border-maroon-300 flex items-center justify-center gap-2'
                                   >
