          ...
          <div className='min-h-screen bg-gradient-to-br from-slate-50 to-red-50 py-8'>
               <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    <div className='text-center mb-8'>
                         <div className='bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-red-100 p-6'>
                              <div className='flex items-center justify-center gap-3 mb-4'>
                                   ...
                                   <div>
                                        <h1 className='text-3xl font-bold text-red-800'>Add Subject to Branch</h1>
                                        <p className='text-red-600 mt-1'>Add a new subject to an existing department-year-branch</p>
                                   </div>
                              </div>
                         </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                         ...
                         <div className='lg:col-span-2'>
                              <div className='bg-white/80 backdrop-blur-md rounded-2xl shadow-xl border border-red-100 overflow-hidden'>
                                   <div className='bg-gradient-to-r from-red-600 to-red-700 px-6 py-4'>
                                        <h2 className='text-xl font-semibold text-white'>Subject Information</h2>
                                        <p className='text-red-100 text-sm'>Select branch and enter subject details</p>
                                   </div>
