//Teacher=> take attendance page for teachers 
...
export default function AttendancePage() {
  ...
  useEffect(() => {
    ...
    socket.on("MarkAttByStudentEvent", handler);
    return () => {
      socket.off("MarkAttByStudentEvent", handler); // Proper cleanup
    };
  }, []);
  ...
  const handleAddStudent = async () => {
    ...
    socket.emit(
      "add_Student_Attendance_Manually_By_Teacher",
      bodyData,
      (response) => {
  ...
  const handleSubmitPin = async () => {
    ...
    try {
      ...
      toast.error(error.response.data?.message || "Error activating class");
    }
  }
  ...
  const submitRecord = async () => {
    ...
    try {
      ...
      toast.error(error.response.data?.message || "Error in submitting record");
    }
  }
