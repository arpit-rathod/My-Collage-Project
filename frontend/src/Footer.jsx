...
const Footer = () => {
     return (
          <footer className="bg-white relative border-t-2 border-red-700 w-full" >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                         ...
                         <div className="space-y-4">
                              ...
                              <address className="not-italic text-gray-600 space-y-2">
                                   ...
                                   <p>Truba Group of Institutes</p>
                                   <p>Bhopal, Madhya Pradesh</p>
                                   {/* <p className="mt-2 space-y-1"> */}
                                   {/* </p> */}
                                   <p className="font-medium">Phone: +91-9202901000</p>
                                   <p className="font-medium">Phone: 0755-2734691,92</p>
                                   <p>
